...
from boto3_wasabi.docs.base import BaseDocumenter
from boto3_wasabi.docs.action import ActionDocumenter
from boto3_wasabi.docs.waiter import WaiterResourceDocumenter
from boto3_wasabi.docs.collection import CollectionDocumenter
from boto3_wasabi.docs.subresource import SubResourceDocumenter
from boto3_wasabi.docs.attr import document_attribute
from boto3_wasabi.docs.attr import document_identifier
from boto3_wasabi.docs.attr import document_reference
from boto3_wasabi.docs.utils import get_identifier_args_for_signature
from boto3_wasabi.docs.utils import get_identifier_values_for_example
from boto3_wasabi.docs.utils import get_identifier_description
from boto3_wasabi.docs.utils import add_resource_type_overview
...
class ResourceDocumenter(BaseDocumenter):
    ...
    def _add_example(self, section, identifier_names):
        ...
        section.write('import boto3_wasabi')
        section.style.new_line()
        section.style.new_line()
        section.write(
            '%s = boto3_wasabi.resource(\'%s\')' % (
