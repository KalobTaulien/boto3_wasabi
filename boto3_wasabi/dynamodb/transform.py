...
from boto3_wasabi.dynamodb.types import TypeSerializer, TypeDeserializer
from boto3_wasabi.dynamodb.conditions import ConditionBase
from boto3_wasabi.dynamodb.conditions import ConditionExpressionBuilder
from boto3_wasabi.docs.utils import DocumentModifiedShape
...
class DynamoDBHighLevelResource(object):
    def __init__(self, *args, **kwargs):
        ...
        key_expression_shape_docs = DocumentModifiedShape(
            'KeyExpression',
            new_type=(
                'condition from :py:class:`boto3_wasabi.dynamodb.conditions.Key` '
                'method'
            ),
            new_description=(
        ...
        con_expression_shape_docs = DocumentModifiedShape(
            'ConditionExpression',
            new_type=(
                'condition from :py:class:`boto3_wasabi.dynamodb.conditions.Attr` '
                'method'
            ),
            new_description=(
