...
from boto3_wasabi.docs.docstring import ActionDocstring
from boto3_wasabi.utils import inject_attribute
...
class ServiceAction(object):
    ...
    :type action_model: :py:class`~boto3_wasabi.resources.model.Action`
...
class BatchAction(ServiceAction):
    ...
    def __call__(self, parent, *args, **kwargs):
        ...
        :type parent:
            :py:class:`~boto3_wasabi.resources.collection.ResourceCollection`
...
class WaiterAction(object):
    ...
    :type waiter_model: :py:class`~boto3_wasabi.resources.model.Waiter`
