...
class ResourceCollection(object):
    ...
    :type model: :py:class:`~boto3_wasabi.resources.model.Collection`
    :param model: Collection model
    :type parent: :py:class:`~boto3_wasabi.resources.base.ServiceResource`
    :param parent: The collection's parent resource
    :type handler: :py:class:`~boto3_wasabi.resources.response.ResourceHandler`
    ...
    def pages(self):
        ...
        :rtype: list(:py:class:`~boto3_wasabi.resources.base.ServiceResource`)
    ...
    def page_size(self, count):
        ...
        Fetch at most this many resources per service request.
            ...
            >>> for obj in s3.Bucket('boto3_wasabi').objects.page_size(100):
            ...     print(obj.key)
...
class CollectionManager(object):
    ...
    Get whole pages of items:
        ...
        >>> for page in s3.Bucket('boto3_wasabi').objects.pages():
        ...     for obj in page:
        ...         print(obj.key)
    ...
    :type collection_model: :py:class:`~boto3_wasabi.resources.model.Collection`
    :param model: Collection model

    :type parent: :py:class:`~boto3_wasabi.resources.base.ServiceResource`
    :param parent: The collection's parent resource

    :type factory: :py:class:`~boto3_wasabi.resources.factory.ResourceFactory`
    :param factory: The resource factory to create new resources

    :type service_context: :py:class:`~boto3_wasabi.utils.ServiceContext`
...
class CollectionFactory(object):
    ...
    subclasses from a :py:class:`~boto3_wasabi.resources.model.Collection`
