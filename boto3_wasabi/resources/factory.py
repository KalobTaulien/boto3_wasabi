...
class ResourceFactory(object):
    """
    A factory to create new :py:class:`~boto3_wasabi.resources.base.ServiceResource`
    classes from a :py:class:`~boto3_wasabi.resources.model.ResourceModel`. There are
    ...
    def load_from_definition(self, resource_name,
        ...
        :py:class:`~boto3_wasabi.resources.base.ServiceResource` subclass
        ...
        :rtype: Subclass of :py:class:`~boto3_wasabi.resources.base.ServiceResource`
    ...
    def _load_collections(self, attrs, resource_model, service_context):
        ...
        a :py:class:`~boto3_wasabi.resources.collection.CollectionManager` instance
