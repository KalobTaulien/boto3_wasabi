...
from boto3_wasabi.s3.transfer import TransferConfig, S3Transfer
from boto3_wasabi.s3.transfer import ProgressCallbackInvoker
...
def copy(self, CopySource, Bucket, Key, ExtraArgs=None, Callback=None,
    ...
    :type SourceClient: botocore or boto3_wasabi Client
