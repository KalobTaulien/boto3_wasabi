...
import boto3_wasabi
import boto3_wasabi.utils
from boto3_wasabi.exceptions import ResourceNotExistsError, UnknownAPIVersionError
...
class Session(object):
    ...
    def __init__(self, aws_access_key_id=None, aws_secret_access_key=None,
        ...
        if self._session.user_agent_name == 'Botocore':
            ...
            if self._session.user_agent_extra:
                ...
                self._session.user_agent_extra = botocore_info
            self._session.user_agent_name = 'boto3_wasabi'
            self._session.user_agent_version = boto3_wasabi.__version__
    ...
    def resource(self, service_name, region_name=None, api_version=None,
        ...
        :return: Subclass of :py:class:`~boto3_wasabi.resources.base.ServiceResource`
        """
        try:
        ...
        if api_version is None:
            ...
            # to track this api_version in boto3_wasabi in order to ensure
            # we're pairing a resource model with a client model
            # of the same API version.  It's possible for the latest
            # API version of a resource model in boto3_wasabi to not be
        ...
        service_context = boto3_wasabi.utils.ServiceContext(
                service_name=service_name, service_model=service_model,
                resource_json_definitions=resource_model['resources'],
                service_waiter_model=boto3_wasabi.utils.LazyLoadedWaiterModel(
    ...
    def _register_default_handlers(self):
        ...
        self._session.register(
            ...
            boto3_wasabi.utils.lazy_call(
                'boto3_wasabi.s3.inject.inject_s3_transfer_methods'))
        self._session.register(
            'creating-resource-class.s3.Bucket',
            boto3_wasabi.utils.lazy_call(
                'boto3_wasabi.s3.inject.inject_bucket_methods'))
        self._session.register(
            'creating-resource-class.s3.Object',
            boto3_wasabi.utils.lazy_call(
                'boto3_wasabi.s3.inject.inject_object_methods'))
        self._session.register(
            'creating-resource-class.s3.ObjectSummary',
            boto3_wasabi.utils.lazy_call(
                'boto3_wasabi.s3.inject.inject_object_summary_methods'))

        # DynamoDb customizations
        self._session.register(
            'creating-resource-class.dynamodb',
            boto3_wasabi.utils.lazy_call(
                'boto3_wasabi.dynamodb.transform.register_high_level_interface'),
            unique_id='high-level-dynamodb')
        self._session.register(
            'creating-resource-class.dynamodb.Table',
            boto3_wasabi.utils.lazy_call(
                'boto3_wasabi.dynamodb.table.register_table_methods'),
        ...
        self._session.register(
            ...
            boto3_wasabi.utils.lazy_call(
                'boto3_wasabi.ec2.createtags.inject_create_tags'))

        self._session.register(
            'creating-resource-class.ec2.Instance',
            boto3_wasabi.utils.lazy_call(
                'boto3_wasabi.ec2.deletetags.inject_delete_tags',
