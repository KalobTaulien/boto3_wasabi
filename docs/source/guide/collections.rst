...
:py:meth:`~boto3_wasabi.resources.collection.Collection.filter` method to filter
the results::
...
by using either the
:py:meth:`~boto3_wasabi.resources.collection.ResourceCollection.limit` method::
...
:py:meth:`~boto3_wasabi.resources.collection.ResourceCollection.page_size` method::
