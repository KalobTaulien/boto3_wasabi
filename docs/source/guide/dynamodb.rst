...
:py:meth:`DynamoDB.ServiceResource.create_table` method::
    ...
    dynamodb = boto3_wasabi.resource('dynamodb')
...
you will need to import the :py:class:`boto3_wasabi.dynamodb.conditions.Key` and
:py:class:`boto3_wasabi.dynamodb.conditions.Attr` classes. The
:py:class:`boto3_wasabi.dynamodb.conditions.Key` should be used when the
condition is related to the key of the item.
The :py:class:`boto3_wasabi.dynamodb.conditions.Attr` should be used when the
condition is related to an attribute of the item::

    from boto3_wasabi.dynamodb.conditions import Key, Attr
