...
.. _aws-boto3_wasabi-iam-examples-policies:
...
* `create_policy <https://boto3_wasabi.readthedocs.io/en/latest/reference/services/iam.html#IAM.Client.create_policy>`_.

* `get_policy <https://boto3_wasabi.readthedocs.io/en/latest/reference/services/iam.html#IAM.Client.get_policy>`_.

* `attach_role_policy <https://boto3_wasabi.readthedocs.io/en/latest/reference/services/iam.html#IAM.Client.attach_role_policy>`_.

* `detach_role_policy <https://boto3_wasabi.readthedocs.io/en/latest/reference/services/iam.html#IAM.Client.detach_role_policy>`_.
