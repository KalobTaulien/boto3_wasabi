...
A Sample Tutorial
=================
This tutorial will show you how to use boto3_wasabi with an AWS service. In this
sample tutorial, you will learn how to use boto3_wasabi with 
...
You can also create messages with custom attributes::
    ...
    queue.send_message(MessageBody='boto3_wasabi', MessageAttributes={
        'Author': {
            'StringValue': 'Daniel',
            'DataType': 'String'
        }
