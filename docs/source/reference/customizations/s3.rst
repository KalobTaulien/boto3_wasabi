...
.. note::
   ...
   exposed to breaking changes. If a class from the ``boto3_wasabi.s3.transfer``
...
.. autoclass:: boto3_wasabi.s3.transfer.TransferConfig
   :members:
   :undoc-members:

.. autoclass:: boto3_wasabi.s3.transfer.S3Transfer
   :members:
   :undoc-members:
