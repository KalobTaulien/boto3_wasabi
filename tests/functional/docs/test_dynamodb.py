...
from boto3_wasabi.docs.service import ServiceDocumenter
    ...
    def test_conditions_is_documented(self):
        ...
        self.assert_contains_lines_in_order([
            (':type FilterExpression: condition from '
             ':py:class:`boto3_wasabi.dynamodb.conditions.Attr` method'),
            ...
            (':type KeyConditionExpression: condition from '
             ':py:class:`boto3_wasabi.dynamodb.conditions.Key` method'),
