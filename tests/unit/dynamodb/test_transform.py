...
from boto3_wasabi.resources.base import ResourceMeta, ServiceResource
from boto3_wasabi.dynamodb.transform import ParameterTransformer
from boto3_wasabi.dynamodb.transform import TransformationInjector
from boto3_wasabi.dynamodb.transform import DynamoDBHighLevelResource
from boto3_wasabi.dynamodb.transform import register_high_level_interface
from boto3_wasabi.dynamodb.transform import copy_dynamodb_params
...
class TestDynamoDBHighLevelResource(unittest.TestCase):
    ...
    def test_instantiation(self):
        ...
        dynamodb_class = type(
            ...
            {'meta': self.meta})
        with mock.patch('boto3_wasabi.dynamodb.transform.TransformationInjector') \
                as mock_injector:
            with mock.patch(
                'boto3_wasabi.dynamodb.transform.DocumentModifiedShape.'
