...
from boto3_wasabi.resources.action import BatchAction, ServiceAction, WaiterAction
from boto3_wasabi.resources.base import ResourceMeta
from boto3_wasabi.resources.model import Action, Waiter
...
class TestServiceActionCall(BaseTestCase):
    ...
    @mock.patch('boto3_wasabi.resources.action.create_request_parameters',
                return_value={})
    ...
    @mock.patch('boto3_wasabi.resources.action.create_request_parameters',
                return_value={})
    @mock.patch('boto3_wasabi.resources.action.RawHandler')
    ...
    @mock.patch('boto3_wasabi.resources.action.create_request_parameters',
                return_value={})
    @mock.patch('boto3_wasabi.resources.action.ResourceHandler')
