...
from boto3_wasabi.resources.collection import CollectionFactory, CollectionManager, \
                                       ResourceCollection
from boto3_wasabi.resources.base import ResourceMeta
from boto3_wasabi.resources.factory import ResourceFactory
from boto3_wasabi.resources.model import Collection
...
class TestCollectionFactory(BaseTestCase):
    ...
    @mock.patch('boto3_wasabi.resources.collection.BatchAction')
...
class TestResourceCollection(BaseTestCase):
    ...
    @mock.patch('boto3_wasabi.resources.collection.ResourceHandler')
