...
from boto3_wasabi.exceptions import ResourceLoadException
from boto3_wasabi.utils import ServiceContext
from boto3_wasabi.resources.base import ServiceResource
from boto3_wasabi.resources.collection import CollectionManager
from boto3_wasabi.resources.factory import ResourceFactory
from boto3_wasabi.resources.action import WaiterAction
...
class TestResourceFactory(BaseTestResourceFactory):
    ...
    @mock.patch('boto3_wasabi.resources.factory.ServiceAction')
    ...
    @mock.patch('boto3_wasabi.resources.model.Collection')
    ...
    @mock.patch('boto3_wasabi.resources.factory.WaiterAction')
