...
from boto3_wasabi.resources.model import ResponseResource, Parameter
from boto3_wasabi.resources.factory import ResourceFactory
from boto3_wasabi.resources.response import build_identifiers, build_empty_response,\
...
class TestResourceHandler(BaseTestCase):
    ...
    @mock.patch('boto3_wasabi.resources.response.build_empty_response')
