...
from boto3_wasabi.exceptions import RetriesExceededError
from boto3_wasabi.exceptions import S3UploadFailedError
from boto3_wasabi.s3.transfer import create_transfer_manager
from boto3_wasabi.s3.transfer import S3Transfer
from boto3_wasabi.s3.transfer import OSUtils, TransferConfig, ProgressCallbackInvoker
from boto3_wasabi.s3.transfer import ClientError, S3TransferRetriesExceededError
...
class TestCreateTransferManager(unittest.TestCase):
    def test_create_transfer_manager(self):
        ...
        osutil = OSUtils()
        with mock.patch('boto3_wasabi.s3.transfer.TransferManager') as manager:
    ...
    def test_create_transfer_manager_with_no_threads(self):
        ...
        with mock.patch(
                'boto3_wasabi.s3.transfer.TransferManager') as manager:
