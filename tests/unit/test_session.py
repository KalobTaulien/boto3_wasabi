...
from boto3_wasabi import __version__
from boto3_wasabi.exceptions import NoVersionFound, ResourceNotExistsError
...
class TestSession(BaseTestCase):
    ...
    def test_user_agent(self):
        ...
        self.assertEqual(bc_session.user_agent_name, 'boto3_wasabi')
    ...
    def test_bad_resource_name_with_no_client_has_simple_err_msg(self):
        ...
        # 'bad-client' it not a valid boto3_wasabi.client(...)
        self.assertNotIn('boto3_wasabi.client', err_msg)
