...
from boto3_wasabi import utils
...
class TestUtils(unittest.TestCase):
    def test_lazy_call(self):
        with mock.patch('boto3_wasabi.utils.import_module') as importer:
    ...
    def test_import_module(self):
        module = utils.import_module('boto3_wasabi.s3.transfer')
        self.assertEqual(module.__name__, 'boto3_wasabi.s3.transfer')
